...
export default async function Home() {
  ...
  return (
    <main className="home">
      <div className="flex flex-row bg-blue-800 mx-20 p-5 rounded-lg shadow-md mb-6">
          <h1 className="text-2xl font-bold">Welcome to your Task List!</h1>
      </div>
      
      <div className="flex container mx-20 p-10 gap-6 space-x-6">

        <div className="flex flex-row bg-blue-800 p-5 rounded-lg space-x-6 shadow-md mb-6">
        ...
        <div className="flex flex-row mx-20 bg-blue-800 p-5 rounded-lg space-x-6 shadow-md mb-6">
        ...
        <div className="flex container mx-20 p-10 gap-6 space-x-6">
          <div className="flex bg-blue-800 p-6 rounded-lg shadow-md space-x-3.5">

            <h2 className="flex text-2xl font-bold ">Features</h2>
