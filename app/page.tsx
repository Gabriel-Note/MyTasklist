  ...
  return (
    <main className="home">
      <div className="bg-sage max-w-xl mx-auto p-5 rounded-lg shadow-md mb-6 font-extrabold text-center">
          <h1 className="text-2xl text-white font-bold">Welcome to your Task List!</h1>
      </div>
      
      <div className="flex container mx-20 p-10 gap-6 space-x-6">

        <div className="flex flex-row bg-dustyrose p-5 rounded-lg space-x-6 shadow-md mb-6 text-white font-bold">
        ...
        <div className="flex flex-row mx-20 bg-dustyrose p-5 rounded-lg space-x-6 shadow-md mb-6 text-white font-bold">
        ...
        <div className="flex container mx-20 p-10 gap-6 space-x-6 justify-center">
          <div className="flex bg-dustyrose p-6 rounded-lg  shadow-md space-x-3.5">

            <h2 className="flex text-2xl font-extrabold text-white ">Features</h2>
            <ul className="list-disc list-inside mt-2 text-white font-bold">
